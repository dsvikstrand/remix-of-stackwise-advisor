...
This broad umbrella has been superseded by narrower ownership chapters and the current queue-slot alignment plan. Do not resume it directly; create a new bounded plan instead.
