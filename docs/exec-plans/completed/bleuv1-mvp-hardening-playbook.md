...
a4xte1a) [have] Feed-row upgrades now also preserve the existing wall `created_at`, so when a locked/unlockable Home row becomes a generated blueprint it keeps its original wall position instead of jumping back to the top.
