# Golden BP Prompt Contract v4

Version: `v4`
Status: Canonical (current)
Owner intent: Generate high-value blueprints with a stable Bluep quality stamp, lighter fast-skim takeaways, and a stricter storyline substance floor.
