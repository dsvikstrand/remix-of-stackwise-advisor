...
a000) [have] Active proof-only tail lives in `docs/exec-plans/active/tail/mvp-launch-proof-tail.md`, while the completed hardening program lives in `docs/exec-plans/completed/mvp-readiness-review-followup.md`.
