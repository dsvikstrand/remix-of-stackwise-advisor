...
a00) [have] Use `docs/ops/mvp-launch-readiness-checklist.md` for launch status, `docs/exec-plans/active/tail/mvp-launch-proof-tail.md` for the remaining active proof work, and `docs/exec-plans/completed/mvp-readiness-review-followup.md` for the completed implementation program.
