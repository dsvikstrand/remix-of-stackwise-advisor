...
- 2026-03-20 note: auth-only `GET /api/my-feed` now provides a backend-shaped hydrated read for the personal lane; this is additive and does not alter the YT2BP request/response envelope.
