...
const draftRow: OutreachDraftStoredRow = {
  ...
  tail_variant_id: 'personal-learning-feed-v1',
  tail_text: 'BLEUP turns new videos into quick, skimmable blueprints. Please visit my channel for more info and free early access.',
  final_text: 'The useful part was the specific idea. BLEUP turns new videos into quick, skimmable blueprints. Please visit my channel for more info and free early access.',
  status: 'drafted',
  model: 'gpt-5.4-mini',
