...
export const LANDING_BACKGROUND_GLYPHS: LandingBackgroundGlyph[] = [
  ...
  },
  {
    ...
    desktopPath: 'M 8 86 C 18 92, 32 88, 44 82 C 50 79, 56 79, 62 82',
    mobilePath: 'M 10 88 C 18 92, 28 88, 38 84 C 44 82, 50 82, 56 84',
    startProgress: 0.06,
    endProgress: 0.78,
    startScale: 0.96,
    endScale: 1.1,
  ...
  },
  {
    ...
    desktopPath: 'M 92 88 C 84 92, 74 88, 64 84 C 58 82, 52 82, 46 84',
    mobilePath: 'M 88 88 C 80 91, 70 88, 60 85 C 54 83, 48 83, 42 85',
    startProgress: 0.05,
    endProgress: 0.76,
    startScale: 0.94,
    endScale: 1.08,
  ...
  },
  {
    ...
    desktopPath: 'M 4 28 C 6 24, 9 22, 14 25 C 12 30, 9 34, 5 33',
    mobilePath: 'M 5 30 C 7 26, 10 24, 14 26 C 12 30, 9 33, 6 32',
    startProgress: 0.12,
    endProgress: 0.38,
    startScale: 0.98,
    endScale: 1.04,
