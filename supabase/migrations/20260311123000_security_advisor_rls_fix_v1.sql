alter table public.source_auto_unlock_intents enable row level security;
alter table public.source_auto_unlock_participants enable row level security;
alter table public.blueprint_youtube_search_cache enable row level security;
alter table public.youtube_quota_state enable row level security;
alter table public.user_generation_daily_usage enable row level security;
alter table public.user_generation_entitlements enable row level security;
alter table public.blueprint_youtube_refresh_state enable row level security;
